...
LOG_DIR=${LOG_DIR:-local/logs/kv_align_hiddenseed_sharedspace_residual_2gpu}
TIMESTAMP=${TIMESTAMP:-$(date +%Y%m%d_%H%M%S)}
LOG_FILE=${LOG_FILE:-${LOG_DIR}/train_eval_kv_align_hiddenseed_sharedspace_residual_2gpu_${TIMESTAMP}.log}
